...
paper/paper.pdf: paper/paper.tex
	cd paper && latexmk -pdf -pdflatex="pdflatex" -use-make paper.tex
	cd ../

poster/poster.pdf: poster/poster.tex
	cd poster && latexmk -pdf -pdflatex="pdflatex" -use-make poster.tex
	cd ../
	
presentation/presentation.pdf: presentation/presentation.tex
	cd presentation && latexmk -pdf -pdflatex="pdflatex" -use-make presentation.tex
	cd ../
