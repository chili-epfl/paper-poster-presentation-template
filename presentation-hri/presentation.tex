...
%Imageless autostarting looping movie
\newcommand{\amovie}[3]{%
	\movie[width=#1,height=#2,autostart,loop]{\rule{#1}{#2}}{#3}%
}

%Full screen video slide
\newcommand{\movieframe}[1]{%
    \setbeamertemplate{navigation symbols}{}%
	\begin{frame}[plain]
		\zeroleftmargin\amovie{\paperwidth}{\paperheight}{#1}
	\end{frame}
}
...
\begin{frame}{Video}
    ...
    Full screen video on the next slide...
